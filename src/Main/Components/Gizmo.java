...
public class Gizmo extends Component implements IPickable{

    private Vector4f xAxisColor = new Vector4f(1, 0, 0, 1);
    private Vector4f xAxisColorHover = new Vector4f(0.3f, 0, 0, 1);
    private Vector4f yAxisColor = new Vector4f(0, 1, 0, 1);
    private Vector4f yAxisColorHover = new Vector4f(0,0.3f,0,1);
    ...
    public Gizmo(Sprite arrowSprite, PropViewer propViewer) {
        this.xAxisObject = Prototypes.generateSprObject(arrowSprite, gizmoWidth, gizmoHeight);
        this.yAxisObject = Prototypes.generateSprObject(arrowSprite, gizmoWidth, gizmoHeight);
    ...
    public void editorUpdate(double dt) {
        ...
        this.activeGameObject = this.propViewer.getActiveGameObject();
    ...
    private boolean checkXHoverState() {
        Vector2f mousePos = new Vector2f(MouseListener.calcWorldX(), MouseListener.calcWorldY());
