...
public class GImGui {
    ...
    private static float defaultColWidth = 180.0f;

    public static void drawVec2Control(String label, Vector2f values) {
        drawVec2Control(label, values, 0.0f, defaultColWidth);
    }

    public static void drawVec2Control(String label, Vector2f values, float resetValue) {
        drawVec2Control(label, values, resetValue, defaultColWidth);
    }
    ...
    public static void drawVec3Control(String label, Vector3f values) {
        drawVec3Control(label, values, 0.0f, defaultColWidth);
    }

    public static void drawVec3Control(String label, Vector3f values, float resetValue) {
        drawVec3Control(label, values, resetValue, defaultColWidth);
    }
    ...
    public static String textInput(String label, String text) {
        ImGui.pushID(label);
        ...
        ImString toString = new ImString(text, 256);
        if (ImGui.inputText("##" + label, toString)) {
            ImGui.columns(1);
            ImGui.popID();
